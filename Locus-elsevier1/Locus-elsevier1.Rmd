...
Where $\delta r$ stand for the difference between the r-band magnitudes for the two stars in each pair, and M is the _Colour Match Limit_ of 0.3. Similarly for $\delta g$ and $\delta i$.
